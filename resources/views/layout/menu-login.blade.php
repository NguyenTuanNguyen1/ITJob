...
<body>
    <div class="menu-desktop">
        ...
        <div class="right-login">
            <button class="setting-right-menu">
                <i class="far fa-comment-dots" style="color: #55d553;"></i>
            </button>
            <button class="setting-right-menu">
                <i class="far fa-bell" style="color: #55d553;"></i>
            </button>
            <span class="setting-right-user">
                <i class="fas fa-user-circle" style="color: #42d62e;"></i>
            </span>
