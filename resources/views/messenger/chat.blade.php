...
<script type="text/javascript">
    ...
    function load_data() {
        $.get('http://itjob.vn/messenger/{{ Auth::user()->id }}', (res) => {
            let _li = '';
            ...
            data.forEach(function (item) {
                ...
                if(item.from_user_id == auth)
                {
                    ...
                    _li += '<div class="message-data text-right">';
                    _li += '<span class="message-data-time">' + item.created_at + '</span>'
                    _li += '</div>';
                    _li += '<div class="message other-message float-right">'+ item.message +'</div>'
                    _li += '</li>';
                }
                else
                {
                    _li += '<li class="clearfix">';
                    _li += '<div class="message-data">';
                    _li += '<span class="message-data-time">' + item.created_at + '</span>'
                    _li += '</div>';
                    _li += '<div class="message my-message">'+ item.message +'</div>'
                    _li += '</li>';
                }
                $('#message').html(_li).first();
            })
        });
    }
