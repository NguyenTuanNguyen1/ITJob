...
<head>
    ...
    <link href="url{{"home/lib/tempusdominus/css/tempusdominus-bootstrap-4.min.css"}}" rel="stylesheet" />
    ...
    <div class="container-fluid bg-dark px-0">
        <div class="row gx-0">
            <div class="col-lg-3 bg-dark d-none d-lg-block">
                <a href="home/index.html" class="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-center">
...
<script src="url{{"home/lib/counterup/counterup.min.js"}}"></script>
<script src="url{{"home/lib/owlcarousel/owl.carousel.min.js"}}"></script>
<script src="url{{"home/lib/tempusdominus/js/moment.min.js"}}"></script>
<script src="url{{"home/lib/tempusdominus/js/moment-timezone.min.js"}}"></script>
<script src="url{{"home/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"}}"></script>
