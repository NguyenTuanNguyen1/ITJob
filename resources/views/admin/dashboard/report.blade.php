                        ...
                        <table class="table">
                            <thead class=" text-primary">
                                ...
                                <tr>
                                    ...
                                    <td style="width:50%">{{ $not_reply->content }}</td>
                                    <td>
                                        <!-- <button class="btn" data-target="#modal1"><img
                                                src="{{ url('board-master/images/person_1.jpg')}}" width="50px"
                                                height="50px"></button> -->
                                        <button class="btn btn-outline-success" type="submit"
                                            data-value="123" data-toggle="modal" data-target="#modalReportImage"
                                            id="btn-reply" value="{{ $not_reply->id }}"><img
                                                src="{{ url('board-master/images/person_1.jpg')}}" width="50px"
                                                height="50px">
                                        </button>
                                    </td>
                                    ...
                                    <td>
                                        <button class="btn btn-outline-danger" type="submit" style="margin: 5px"
                                            data-value="123" data-toggle="modal" data-target="#modalReport"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-outline-success" type="submit" style="margin: 5px"
                                            data-value="123" data-toggle="modal" data-target="#modalDetailReport"
