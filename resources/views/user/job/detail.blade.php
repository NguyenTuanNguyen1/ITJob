            ...
            <ul class="job-listings mb-5">
                ...
                <li class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center">
                    ...
                    <div class="job-listing-logo">
                        <img src="{{ url('Images/')}}/{{ $post_major->getImageAttribute()}}" width="70" height="50"
                            class="img-fluid">
                    </div>
...
$(document).ready(() => {
    ...
    $.get('http://itjob.vn/post/post-detail/{{$post->id}}', (res) => {
        ...
        _li += '<div class="mb-5">';
        _li +=
            '<h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-align-left mr-3"></span>Lợi ích</h3>';
        _li += ' ' + data.benefit + ' </span>';
        _li += '</div>';
        _li += '<div class="mb-5">';
        _li +=
            '<h3 class="h5 d-flex align-items-center mb-4 text-primary"><span class="icon-align-left mr-3"></span>Yêu cầu</h3>';
