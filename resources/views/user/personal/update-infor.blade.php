                ...
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    <form action="{{ Route('user.update.basic') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="container1" id="imgBox">
                            ...
                            <label for="file"><img src="http://127.0.0.1:8000/board-master/images/upload.png"
                        ...
                        <div class="d-flex align-items-center text-center p-1 py-3">
                            ...
                            <input type="text" name="name" value="{{ $user->name }}" id=""
                                style="border-radius:5px;margin-right:4px;margin-left:7px;width:77%">
                ...
                <div class="p-3 py-5">
                    <div class="tab" style="display:flex;">
                        <button class="tablinks" onclick="openCity(event, 'London')"
                            style="font-size: 15px;font-weight: bold;">Thông tin cá nhân</button>
                        <button class="tablinks" onclick="openCity(event, 'Paris')"
                            style="font-size: 15px;font-weight: bold;">Thông tin thêm</button>
                        <button class="tablinks" onclick="openCity(event, 'Tokyo')"
                            style="font-size: 14px;font-weight: bold;">Bình luận đánh giá</button>
                        <button class="tablinks" onclick="openCity(event, 'France')"
                            style="font-size: 15px;font-weight: bold;">Đổi mật khẩu</button>
                        <button class="tablinks" onclick="openCity(event, 'Autris')"
                            style="font-size: 15px;font-weight: bold;">Phản hồi</button>
                    </div>
                        ...
                        <div id="France" class="tabcontent">
                            <div class="col mt-3">
                                <form action="" method="post">
                                    <div class="col-md-6" style="margin-left:25%;padding-top: 10px">
                                        <label style="margin-bottom:0">Nhập mật khẩu hiện tại</label>
                                    ...
                                    <div class="col-md-6" style="margin-left:25%;padding-top: 10px">
                                        <label style="margin-bottom:0">Nhập mật khẩu mới</label>
                                        <input type="password" class="inputpass" name="email" value="">
                                        @error('email')
                                        <div style="color:red;">{{ $message }}</div>
                                        <br>
                                    ...
                                    <div class="col-md-6" style="margin-left:25%;padding-top: 10px">
                                        <label style="margin-bottom:0">Nhập lại mật khẩu mới</label>
                                        <input type="password" class="inputpass" name="email" value="">
                                        @error('email')
                                        <div style="color:red;">{{ $message }}</div>
                                        <br>
                                    ...
                                    <div class="mt-2 text-center">
                                        <button class="btn btn-primary profile-button" type="button">Xác nhận
                                        </button>
                                    </div>
                                </form>
                    ...
                    <div>
                        <div id="Autris" class="tabcontent">
                            <div class="col mt-3">
                                <fieldset>
                                    <div class="row">
                                        <div class="col-sm-3 col-lg-2 hidden-xs">
                                            <img class="img-responsive"
                                                src="{{ url('Images/') }}/{{ Auth::user()->img_avatar }}" alt="">
                                        </div>
                                        <div class="form-group col-xs-12 col-sm-9 col-lg-10">
                                            <textarea class="form-control" id="message" placeholder="Bình luận tại đây"
                                                required=""></textarea>
                                        </div>
                                    </div>
                                </fieldset>
