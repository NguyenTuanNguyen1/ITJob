                ...
                <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                        ...
                        <div class="row align-items-center gx-3">
                            ...
                            <div class="col-auto" style="position: absolute;left: 80%;">
                                ...
                                <div class="dropdown-menu">
                                    <a class="ml-3" href="{{ Route('company.storage',['id' => $post->id]) }}" style="text-decoration: none; color: black">Chi tiết bài viết</a>
                                </div>
                            </div>
                        </div>
                        <!--//row-->
                    ...
                    <div class="app-card-body px-4">
                        ...
                        <div class="app-card-footer p-4 mt-auto">
                            <button class="btn btn-outline-success" id="btn-restore" value="{{ $post->id }}" > Khôi phục bài viết</button>
                        </div>
                </div>
            </div>
        @endforeach
