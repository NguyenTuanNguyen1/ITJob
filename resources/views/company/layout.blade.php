...
{{--                        </div><!--//app-utility-item-->--}}
                        ...
                        <div class="app-utility-item app-user-dropdown dropdown">
                            <a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
                               role="button" aria-expanded="false"><img src="{{ url('image_avatar') }}/{{ Auth::user()->img_avatar }}" alt="user profile"></a>
                            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                                <li><a class="dropdown-item" href="{{ Route('company.profile') }}">Thông tin cá nhân</a></li>
                                <li><a class="dropdown-item" href="{{ Route('company.post.create') }}">Đăng bài viết</a></li>
    ...
    <div id="app-sidepanel" class="app-sidepanel">
        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <div class="app-branding">
                <a class="app-logo" href="index.html"><span class="logo-text">FINDING JOB</span></a>
