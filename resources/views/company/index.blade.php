                        ...
                        <div class="app-card-header p-3 border-bottom-1 ">
                            <div class="row align-items-center gx-3">
                                <div class="row">
                                    ...
                                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" @if($post->status != 1) title="Chưa phê duyệt" @else title="Đã phê duyệt"  @endif >
                                         <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-receipt" @if($post->status != 1) style="color:red" @endif 
                                ...
                                <div class="col-auto" style="position: absolute;left: 80%;">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="ml-3" href="{{ Route('post.update',['id' => $post->id]) }}" style="text-decoration: none; color: black">Chỉnh sửa bài viết</a>

                                    </div>
                                </div>
                                </div>
                                    <div class="col-auto">
                                        <h3 class="app-card-title"> {{ $post->title }}</h3d>
                                    </div>
                            </div>
                            <!--//row-->
                        </div>
